...
Nethesis Support can answer within 4 hours but just between 9-18 Italian timezone. That's why 1 business day

### How many subscriptions do I need?
Each NethServer that will join the Support Program needs a subscription. Every subscription key is bound to the unique "Server ID" of your server.

### How many support tickets do I get in total if I buy two or more NethServer Support Program subscriptions?
With every subscription you purchase you will get a certain amount of included support tickets. For example: If you run two servers with NethServer and you order two Basic Subscriptions (each with three support tickets included) you have in total six support tickets, three for each server.)

### I'd like to subscribe many NethServer
Having already have a fair amount of installations (more than 5) or you plan to add new installations, you could find interesting joining the Partner Program. It offers more affordable prices when the number of installations increases.


## How can I join the Support Program?
We're not ready to offer the program yet but we will get you in touch.
Please submit the form below providing your contact information, you will added to our waitlist
...
## Why join a NethServer Partner Program?
Being a partner enables you to successfully deploy and manage your servers. Our open approach gives you direct access to Nethesis engineers, the latest knowledge and best practices. We provide technical expertise, guidance and collaboration with phone and email. 

With the NethServer Partner program you get:

* Huge profit margin
* Wide application suite that meets all your needs.
* Access to the core Nethesis engineers
* High quality referrals
* Full lifecycle support with up to 15 years security and stability fixes 
* Professional Support by phone, email or helpdesk portal.
 * Technical expertise and help covering project inception to production 
 * Technical pre-sales support
* Additional products based on [NethServer Enterprise](http://www.nethserver.org/community-vs-enterprise/) like:
 * NethVoice: enteprise PBX based on Asterisk and FreePBX. With integrated video conferencing and communication features based on WebRTC
 * NethCTI: softphone with WebRTC technology, presence panel, mobile app and CRM integrations.
 * NethMonitor:  proactive monitoring of computer networks.
* Help to scale your NethServer installations
